                    ...
                    <div :class="$style['row']">
                        ...
                        <div :class="$style['content']">
                            <el-form-item prop="channelNo">
                                <el-select placeholder="请选择" size="max" :disabled="updateId != ''" v-model="form.channelNo">
                                    <el-option
                                            :key="item.value"
                                            :label="item.codeName"
                                            :value="item.code"
                    ...
                    <div :class="$style['row']">
                        ...
                        <div :class="[$style['content'],$style['last-box']]">
                            <el-form-item prop="channelType">
                                <el-select placeholder="请选择" :disabled="disabled === 1" size="max" v-model="form.channelType">
                                    <el-option
                                            :key="item.value"
                                            :label="item.label"
                                            :value="item.value"
                    ...
                    <div :class="$style['row']">
                        ...
                        <div :class="[$style['content'],$style['textarea-content'],$style['last-box']]">
                            <el-form-item :class="$style['textarea-mt10']" prop="sqlSentence">
                                <el-input rows="5" type="textarea" :disabled="disabled === 1" v-model="form.sqlSentence"></el-input>
                            </el-form-item>
                        </div>
                    </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                disabled: 1, // 是否可以修改 2:可以修改,1:不可以修改
            }
        },
        computed: {
            ...mapGetters(['userInfo'])
